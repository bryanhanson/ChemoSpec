...
%\VignetteDepends{chemometrics, robustbase, RColorBrewer, plyr, pcaPP, mvtnorm, mvoutlier, pls, lattice, grid, rgl, R.utils, mclust, ggplot2}
...
(Chromatograms too!)\\
Version 1.48-3 (compatible with R 2.14.0)}
...
rm(list = ls()) # may not be necessary here, but won't hurt
